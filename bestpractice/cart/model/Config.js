...
model.Config.getHost = function () {
	// If you want to use mock add the following URL param "responderOn=true".
	// This will in turn load the data from the Mock Data in the model folder
	return "http://ec2-54-225-119-138.compute-1.amazonaws.com:50000";
};